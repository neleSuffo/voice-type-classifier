...
Protocols:
  ${bn}_protocol:
    ...
    OUTPUT=output_voice_type_classifier_cl_v2/$bn/
    mkdir -p output_voice_type_classifier_cl_v2/$bn/
    ...
    VAL_DIR=$THISDIR/model/train/ChildLens.SpeakerDiarization.audio.train_cl_v2/validate_average_detection_fscore/ChildLens.SpeakerDiarization.audio.development
