...
Protocols:
  ${bn}_protocol:
    ...
    OUTPUT=output_voice_type_classifier_qt/$bn/
    mkdir -p output_voice_type_classifier_qt/$bn/
    ...
    VAL_DIR=$THISDIR/model/train/ChildLens.SpeakerDiarization.audio.train_qt/validate_average_detection_fscore/ChildLens.SpeakerDiarization.audio.development
